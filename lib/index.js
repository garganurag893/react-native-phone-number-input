...
export default class PhoneInput extends PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      code: props.defaultCode ? undefined : "1",
      number: props.value
        ? props.value
        : props.defaultValue
        ? props.defaultValue
        : "",
      modalVisible: false,
      countryCode: props.defaultCode ? props.defaultCode : "CR",
  ...
  async componentDidUpdate(prevProps) {
    ...
    if (defaultCode) {
      ...
      this.setState({ code });
      this.setState({ countryCode: this.props.defaultCode });
    }
  ...
  onChangeText = (text) => {
      ...
      const formatter = new AsYouTypeFormatter(this.props.defaultCode);
      let formatted = '';
      formatter.clear();
